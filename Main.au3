...
Func _Main()
	...
	While $iActive
		...
		; Next Timestep ausrechnen - Sorgt daf�r das es auf jeden Pc gleich schnell abl�uft
...
; Startet alles und pr�ft auf Fehler
Func _Start()
...
; Initialisiert das ge�ffnete Fenster
Func _InitGl()
...
; Bearbeitet �nderungen am Fenster
...
; Setzt das Fenster in den Vollbildmodus und zur�ck
Func _SetGlFullscreen($iFullscreenFlag = True)
	; Andere Variablen
	Dim $aiBits[6] = [8, 8, 8, 0, 8, 0] ; Rot, Gr�n, Blau, Alpha, Depth, Stencil
